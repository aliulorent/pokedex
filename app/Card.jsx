...
function Card({pokemon, handleSelect}) {
  return (
    <div className='flex flex-col items-center relative rounded-b-xl lower-shadow m-[2px] bg-gradient-to-b from-white to-gray-200 hover:to-blue-100 border-gray-100 border-t-4 hover:border-blue-200 hover:border-solid' onClick={()=>handleSelect(pokemon)}>
